...
<body>
                    ...
                    <div class="card-blog">
                        <div class="header">
                            ...
                            <a href="blog-details.html" class="post-thumb">
                                <img src="{{ asset('front_end/assets/img/blog/blog_1.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="body">
                            ...
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('front_end/assets/img/person/person_1.jpg') }}" alt="">
                                    </div>
                ...
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        <div class="header">
                            ...
                            <a href="blog-details.html" class="post-thumb">
                                <img src="{{ asset('front_end/assets/img/blog/blog_2.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="body">
                ...
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        <div class="header">
                            ...
                            <a href="blog-details.html" class="post-thumb">
                                <img src="{{ asset('front_end/assets/img/blog/blog_3.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="body">
                            ...
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('front_end/assets/img/person/person_2.jpg') }}" alt="">
                                    </div>
    ...
    <div class="page-section">
        <div class="container">
            ...
            <p class="bg bg-primary text-center">@if(session('appointment_message')) {{ session('appointment_message') }} @endif</p>
                ...
                <div class="row mt-5 ">
                    ...
                    <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
                        <select name="speciality" id="speciality" class="custom-select">
                            ...
                            <option value="{{ $doctor->doctor_speciality }}">{{ $doctor->doctor_speciality }}</option>
                            @endforeach
                        </select>
                    </div>
    ...
    <div class="page-section banner-home bg-image"
        style="background-image: url('{{ asset('front_end/assets/img/banner-pattern.svg') }}');">
        <div class="container py-5 py-lg-0">
            <div class="row align-items-center">
                <div class="col-lg-4 wow zoomIn">
                    <div class="img-banner d-none d-lg-block">
                        <img src="{{ asset('front_end/assets/img/mobile_app.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-8 wow fadeInRight">
                    <h1 class="font-weight-normal mb-3">Get easy access of all features using One Health Application
                    </h1>
                    <a href="#"><img src="{{ asset('front_end/assets/img/google_play.svg') }}" alt=""></a>
                    <a href="#" class="ml-2"><img src="{{ asset('front_end/assets/img/app_store.svg') }}" alt=""></a>
                </div>
            </div>
        </div>
    </div> <!-- .banner-home -->
